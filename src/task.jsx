...
function Task({ allTodos, handleDeleteTodo }){
    ...
    return(
        <div className="flex flex-col justify-center items-center p-6 border ">
            ...
            <div className="flex    p-2  border">
                ...
                <button type="button" className="flex  justify-center items-ccenter p-2 border rounded-md bg-green-300 hover:bg-green-700">Completed</button>
            
            </div>
                

            <div className=" flex  border bg-white shadow-md rounded-md w-full p-3 mt-4 md:w-1/3">
...
<div className="mt-4 flex flex-col justify-center items-center p-6 border bg-white shadow-md rounded-md w-full md:w-1/3">
          ...
          {allTodos.map((todo, index) => (
            <li key={index} className="p-2 border-b flex justify-between items-center">
              ...
              <div className="flex items-center space-x-3">
                <button onClick={() => handleDeleteTodo(index)} className="text-red-500 hover:text-red-700">
                  🗑️
                </button>
